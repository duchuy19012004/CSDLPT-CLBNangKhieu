...
-- Sử dụng SEQUENCE toàn cục để đảm bảo LogId không trùng giữa các Site
-- =============================================
...
-- =============================================
-- TẠO SEQUENCE TOÀN CỤC CHO LOGID
-- Đảm bảo ID tuần tự không phân biệt bảng nào
-- =============================================
...
BEGIN
    ...
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'INSERT', 'CauLacBo', CAST(i.MaCLB AS NVARCHAR(50)), 'SiteA', 
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'UPDATE', 'CauLacBo', CAST(i.MaCLB AS NVARCHAR(50)), 'SiteA', 
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'DELETE', 'CauLacBo', CAST(d.MaCLB AS NVARCHAR(50)), 'SiteA', 
           N'Xóa CLB: ' + d.TenCLB
    FROM deleted d;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'INSERT', 'CauLacBo', CAST(i.MaCLB AS NVARCHAR(50)), 'SiteB', 
           N'Thêm CLB: ' + i.TenCLB + N' (Khoa: ' + i.TenKhoa + N')'
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'UPDATE', 'CauLacBo', CAST(i.MaCLB AS NVARCHAR(50)), 'SiteB', 
           N'Cập nhật CLB: ' + i.TenCLB
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'DELETE', 'CauLacBo', CAST(d.MaCLB AS NVARCHAR(50)), 'SiteB', 
           N'Xóa CLB: ' + d.TenCLB
    FROM deleted d;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'INSERT', 'GiangVien', i.MaGV, 'SiteA', N'Thêm GV: ' + i.HoTenGV
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'UPDATE', 'GiangVien', i.MaGV, 'SiteA', N'Cập nhật GV: ' + i.HoTenGV
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'DELETE', 'GiangVien', d.MaGV, 'SiteA', N'Xóa GV: ' + d.HoTenGV
    FROM deleted d;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'INSERT', 'GiangVien', i.MaGV, 'SiteB', N'Thêm GV: ' + i.HoTenGV
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'UPDATE', 'GiangVien', i.MaGV, 'SiteB', N'Cập nhật GV: ' + i.HoTenGV
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'DELETE', 'GiangVien', d.MaGV, 'SiteB', N'Xóa GV: ' + d.HoTenGV
    FROM deleted d;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'INSERT', 'SinhVien', i.MaSV, 'SiteA', N'Thêm SV: ' + i.HoTenSV
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'UPDATE', 'SinhVien', i.MaSV, 'SiteA', N'Cập nhật SV: ' + i.HoTenSV
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'DELETE', 'SinhVien', d.MaSV, 'SiteA', N'Xóa SV: ' + d.HoTenSV
    FROM deleted d;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'INSERT', 'SinhVien', i.MaSV, 'SiteB', N'Thêm SV: ' + i.HoTenSV
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'UPDATE', 'SinhVien', i.MaSV, 'SiteB', N'Cập nhật SV: ' + i.HoTenSV
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'DELETE', 'SinhVien', d.MaSV, 'SiteB', N'Xóa SV: ' + d.HoTenSV
    FROM deleted d;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'INSERT', 'LopNangKhieu', CAST(i.MaLop AS NVARCHAR(50)), 'SiteA', N'Thêm lớp: ' + CAST(i.MaLop AS NVARCHAR(50))
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'UPDATE', 'LopNangKhieu', CAST(i.MaLop AS NVARCHAR(50)), 'SiteA', N'Cập nhật lớp: ' + CAST(i.MaLop AS NVARCHAR(50))
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'DELETE', 'LopNangKhieu', CAST(d.MaLop AS NVARCHAR(50)), 'SiteA', N'Xóa lớp: ' + CAST(d.MaLop AS NVARCHAR(50))
    FROM deleted d;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'INSERT', 'LopNangKhieu', CAST(i.MaLop AS NVARCHAR(50)), 'SiteB', N'Thêm lớp: ' + CAST(i.MaLop AS NVARCHAR(50))
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'UPDATE', 'LopNangKhieu', CAST(i.MaLop AS NVARCHAR(50)), 'SiteB', N'Cập nhật lớp: ' + CAST(i.MaLop AS NVARCHAR(50))
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'DELETE', 'LopNangKhieu', CAST(d.MaLop AS NVARCHAR(50)), 'SiteB', N'Xóa lớp: ' + CAST(d.MaLop AS NVARCHAR(50))
    FROM deleted d;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'INSERT', 'BienLai', CAST(i.SoBL AS NVARCHAR(50)), 'SiteA', N'Thêm biên lai: ' + CAST(i.SoBL AS NVARCHAR(50))
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'UPDATE', 'BienLai', CAST(i.SoBL AS NVARCHAR(50)), 'SiteA', N'Cập nhật biên lai: ' + CAST(i.SoBL AS NVARCHAR(50))
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'DELETE', 'BienLai', CAST(d.SoBL AS NVARCHAR(50)), 'SiteA', N'Xóa biên lai: ' + CAST(d.SoBL AS NVARCHAR(50))
    FROM deleted d;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'INSERT', 'BienLai', CAST(i.SoBL AS NVARCHAR(50)), 'SiteB', N'Thêm biên lai: ' + CAST(i.SoBL AS NVARCHAR(50))
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'UPDATE', 'BienLai', CAST(i.SoBL AS NVARCHAR(50)), 'SiteB', N'Cập nhật biên lai: ' + CAST(i.SoBL AS NVARCHAR(50))
    FROM inserted i;
END;
GO
...
BEGIN
    INSERT INTO ActivityLog (LogId, Action, TableName, RecordId, Site, Details)
    SELECT NEXT VALUE FOR ClubManagementGlobal.dbo.seq_ActivityLogId, 'DELETE', 'BienLai', CAST(d.SoBL AS NVARCHAR(50)), 'SiteB', N'Xóa biên lai: ' + CAST(d.SoBL AS NVARCHAR(50))
    FROM deleted d;
END;
GO
