...
CREATE TABLE BienLai (
    ...
    CONSTRAINT FK_BienLai_LopNangKhieu_SiteA FOREIGN KEY (MaLop) REFERENCES LopNangKhieu(MaLop) ON DELETE CASCADE,
...
CREATE TABLE BienLai (
    ...
    MaSV VARCHAR(10) NOT NULL,
    SoTien DECIMAL(18,2) NOT NULL,
    CONSTRAINT FK_BienLai_LopNangKhieu_SiteB FOREIGN KEY (MaLop) REFERENCES LopNangKhieu(MaLop) ON DELETE CASCADE,
