...
CREATE TABLE GiangVien (
    ...
    MaCLB INT NOT NULL,
    CONSTRAINT FK_GiangVien_CauLacBo_SiteA FOREIGN KEY (MaCLB) REFERENCES CauLacBo(MaCLB) ON DELETE CASCADE
);
...
CREATE TABLE SinhVien (
    ...
    MaCLB INT NOT NULL,
    CONSTRAINT FK_SinhVien_CauLacBo_SiteA FOREIGN KEY (MaCLB) REFERENCES CauLacBo(MaCLB) ON DELETE CASCADE
);
...
CREATE TABLE LopNangKhieu (
    ...
    CONSTRAINT FK_LopNangKhieu_GiangVien_SiteA FOREIGN KEY (MaGV) REFERENCES GiangVien(MaGV) ON DELETE CASCADE
);
...
CREATE TABLE BienLai (
    ...
    CONSTRAINT FK_BienLai_LopNangKhieu_SiteA FOREIGN KEY (MaLop) REFERENCES LopNangKhieu(MaLop) ON DELETE NO ACTION,
    CONSTRAINT FK_BienLai_SinhVien_SiteA FOREIGN KEY (MaSV) REFERENCES SinhVien(MaSV) ON DELETE NO ACTION
);
GO
...
CREATE TABLE GiangVien (
    ...
    HoTenGV NVARCHAR(100) NOT NULL,
    MaCLB INT NOT NULL,
    CONSTRAINT FK_GiangVien_CauLacBo_SiteB FOREIGN KEY (MaCLB) REFERENCES CauLacBo(MaCLB) ON DELETE CASCADE
);
...
CREATE TABLE SinhVien (
    ...
    HoTenSV NVARCHAR(100) NOT NULL,
    MaCLB INT NOT NULL,
    CONSTRAINT FK_SinhVien_CauLacBo_SiteB FOREIGN KEY (MaCLB) REFERENCES CauLacBo(MaCLB) ON DELETE CASCADE
);
...
CREATE TABLE LopNangKhieu (
    ...
    MaGV VARCHAR(10) NOT NULL,
    HocPhi DECIMAL(18,2) NOT NULL,
    CONSTRAINT FK_LopNangKhieu_GiangVien_SiteB FOREIGN KEY (MaGV) REFERENCES GiangVien(MaGV) ON DELETE CASCADE
);
...
CREATE TABLE BienLai (
    ...
    MaSV VARCHAR(10) NOT NULL,
    SoTien DECIMAL(18,2) NOT NULL,
    CONSTRAINT FK_BienLai_LopNangKhieu_SiteB FOREIGN KEY (MaLop) REFERENCES LopNangKhieu(MaLop) ON DELETE NO ACTION,
    CONSTRAINT FK_BienLai_SinhVien_SiteB FOREIGN KEY (MaSV) REFERENCES SinhVien(MaSV) ON DELETE NO ACTION
);
GO
...
INSERT INTO GiangVien VALUES ('GV2', N'Trần Văn Minh', 2);
INSERT INTO GiangVien VALUES ('GV3', N'Lê Thị Mai', 3);

INSERT INTO SinhVien VALUES ('SV001', N'Phạm Quốc Anh', 1);
INSERT INTO SinhVien VALUES ('SV002', N'Hoàng Thị Lan', 2);
INSERT INTO SinhVien VALUES ('SV003', N'Đỗ Văn Hùng', 3);
...
INSERT INTO GiangVien VALUES ('GV4', N'Võ Thị Ngọc', 4);
INSERT INTO GiangVien VALUES ('GV5', N'Đặng Minh Tuấn', 5);
INSERT INTO GiangVien VALUES ('GV6', N'Bùi Thị Phương', 6);

INSERT INTO SinhVien VALUES ('SV004', N'Trương Văn Nam', 4);
INSERT INTO SinhVien VALUES ('SV005', N'Lý Thị Hà', 5);
